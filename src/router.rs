...
pub enum Route {
    #[at("/yew-static-site-generator/")]
    Home,
    #[at("/yew-static-site-generator/blog")]
    Blog,
    #[at("/yew-static-site-generator/about")]
    About,
    #[at("/yew-static-site-generator/contact")]
    Contact,
    #[at("/yew-static-site-generator/post/:id")]
    Post { id: String },
    #[not_found]
    #[at("/yew-static-site-generator/404")]
    NotFound,
}
